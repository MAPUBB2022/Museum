...
class ControllerMuseumTest {
    ...
    void delete() {
        ...
        ControllerMuseum.delete("NonExistant"); // does not exist
    }
    ...
    void changeName() {
        ...
        ControllerMuseum.changeName("NonExistant","IDK"); // the name does not exist
    ...
    void addClient() {
        ...
        MuseumRepositoryMemory a = MuseumRepositoryMemory.getInstance();
